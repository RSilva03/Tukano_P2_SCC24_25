...
public interface Blobs {
	 ...
	 */
	tukano.api.Result<Void> upload(String blobId, byte[] bytes, String token);
	 ...
	 */
	tukano.api.Result<byte[]> download(String blobId, String token);
	 ...
	 * 			 NOT_FOUND, if no blob matches the provided blobId
	 */
	tukano.api.Result<Void> delete(String blobId, String token );
